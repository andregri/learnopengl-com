#include "LightCaster_Spotlight.h"
...
namespace getting_started
{
	...
	LightCaster_Spotlight::LightCaster_Spotlight()
		: m_ObjectShader("res/shader/GS-Lighting/lm_vertex.shader", "res/shader/GS-Lighting/lc_spot_obj_fragment.shader"),
	...
	void LightCaster_Spotlight::Draw(core::Camera camera)
	{
		...
		m_ObjectShader.SetUniformVec3f("light.position", camera.Position.x, camera.Position.y, camera.Position.z);
		m_ObjectShader.SetUniformVec3f("light.direction", camera.Front.x, camera.Front.y, camera.Front.z);
		m_ObjectShader.SetUniform1f("light.innerCutOff", glm::cos(glm::radians(12.5f)));
		m_ObjectShader.SetUniform1f("light.outerCutOff", glm::cos(glm::radians(17.5f)));
