...
namespace getting_started
{
	...
	LightingCaster::LightingCaster()
		: m_ObjectShader("res/shader/GS-Lighting/lm_vertex.shader", "res/shader/GS-Lighting/lc_obj_fragment.shader"),
	...
	void LightingCaster::Draw(core::Camera camera)
	{
		...
		m_ObjectShader.SetUniformVec3f("light.direction", -0.2f, 1.0f, -0.3f);
